...
impl Default for QunixThemeSettingsData {
    fn default() -> Self {
        Self {
            background_color: "#0a0016ff".into(),
            text_color: "#ffffff".into(),
            focus_color: "hsla(263, 100%, 48%, 1.00)".into(),
            shadow_opacity: 0.145,
            font_family: "JetBrains Mono".into(),
            sidebar_color: "#050505ff".into(),
            card_color: "#0a0a0aff".into(),
            border_color: "rgba(255, 255, 255, 0.1)".into(),
            border_radius: 8,
            navbar_color: "#111111ff".into(),
            terminal_color: "#000000ff".into(),
            terminal_text_color: "#ffffffff".into(),
            input_color: "#111111ff".into(),
            button_radius: 8,
            input_radius: 8,
            card_radius: 8,
            navbar_height: 64,
            ...
            editor_color: "#000000ff".into(),
            editor_text_color: "#ffffffff".into(),
            listing_color: "#0a0a0aff".into(),
            button_color: "#0a72efff".into(),
        }
    }
}
